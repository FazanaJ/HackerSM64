...
#elif   F3DEX_GBI_3
    gGfxSPTask->task.t.ucode = gspF3DZEX3_fifoTextStart;
    gGfxSPTask->task.t.ucode_data = gspF3DZEX3_fifoDataStart;
    gGfxSPTask->task.t.ucode_size = ((u8 *) gspF3DZEX3_fifoTextEnd - (u8 *) gspF3DZEX3_fifoTextStart);
    gGfxSPTask->task.t.ucode_data_size = ((u8 *) gspF3DZEX3_fifoDataEnd - (u8 *) gspF3DZEX3_fifoDataStart);
#elif   F3DEX2PL_GBI
