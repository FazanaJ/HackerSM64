...
const GeoLayout jrb_area_1_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, -507, -8542, 0, jrb_dl_Plane_003_mesh_layer_1),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, -507, -8542, 0, jrb_dl_Plane_004_mesh_layer_1),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
