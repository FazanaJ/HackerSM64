...
const LevelScript level_bob_entry[] = {
	...
	AREA(1, bob_area_1),
		...
		OBJECT(MODEL_NONE, 14, 17, 818, 0, 0, 0, (0 << 24) | (0x0A << 16), bhvInstantActiveWarp),
	...
	AREA(2, bob_area_2),
		...
		OBJECT(MODEL_AK47, 1707, 767, -1431, 0, 0, 0, (0 << 24) | (0 << 16) | (0 << 8), bhvOneCoin),
		OBJECT(MODEL_AK47, -1187, 270, 2268, 0, 0, 0, (1 << 24) | (1 << 16) | (1 << 8), bhvOneCoin),
		OBJECT(MODEL_NONE, -1146, 317, 1611, 0, 0, 0, (0x0A << 16), bhvInstantActiveWarp),
