...
const LevelScript level_bob_entry[] = {
	...
	AREA(3, bob_area_3),
		...
		OBJECT(MODEL_NONE, -1077, 2500, 3352, 0, -175, 0, (0x0A << 16), bhvInstantActiveWarp),
		OBJECT(MODEL_GOOMBA, -1272, 2500, 1164, 0, -175, 0, (0x0A << 16), bhvGoomba),
		OBJECT(MODEL_GOOMBA, -1311, 2500, -7, 0, -175, 0, (0x0A << 16), bhvGoomba),
		OBJECT(MODEL_GOOMBA, -1324, 2500, -1538, 0, -175, 0, (0x0A << 16), bhvGoomba),
