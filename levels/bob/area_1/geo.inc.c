...
const GeoLayout bob_area_1_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_DISPLAY_LIST(LAYER_OPAQUE, bob_dl_Outer_Ring_mesh_layer_1),
		GEO_DISPLAY_LIST(LAYER_ALPHA, bob_dl_Outer_Ring_mesh_layer_4),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, bob_dl_Walls_mesh_layer_1),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
